...
constexpr unsigned max_line(80); //nombre de caractères par ligne de fichier
constexpr unsigned max_link(3); //nb de connexions max d’un Logement
constexpr unsigned no_link(static_cast<unsigned> (-1)); //exprime qu’un lien n’existe pas
constexpr double infinite_time(1e100); //approx d’un temps infini en secondes
